<template>
		...
		<view v-if="userlogin" style="width: 100%;background-color: #DDDDDD;">
			<nav-bar bgColor="#000032">  </nav-bar>
		...
		background: #fff;">
			...
			<paging :total="dataList.totalRecodes" activecolor="#fff" activebackground="green" :pageSize='20' :footer="true"
			 :current="1" @changes="dd"></paging>
		</view>
		<view v-else class="content">
			<nav-bar type="transparent">1</nav-bar>
			<view class="btn-row">
