<template>
	<view>
		<view
			class="header custom_btn1 colorWhite"
			...
			color: navFontColor, opacity: transparentValue }"
		>
			<view class="left_box">
				<slot name="left">
...
export default {
	...
	created() {
		...
		// 	i++;
		// 	if(i==1){
		// 		This.bgcolor1='#ffff00'
		// 	}else if(i==2){
		// 		This.bgcolor1='#55557f'
		// 	}else if (i==3){
		// 		This.bgcolor1='#55aa7f';
		// 	}else if(i>3){
		// 		i=0;
		// 		this.bgcolor1='#aa55ff';
		// 	}
		// },1000)
	},
	//方法
...
.station {
 ...
 @keyframes mymove{
	0%{background-color:#aa55ff;}
	33%{background-color:#55557f;}
	66%{background-color:#55aa7f;}
	100%{background-color:#aa55ff;}
 }
.header {
	display: flex;
	...
	&.colorWhite {
		.left_info {
			...
			.back {
				background-image: url('../../static/1navBar/icon_back_white.png');
			}
			text {
				background-color: rgba(255, 255, 255, 0.3);
			}
			.home {
				background-image: url('../../static/1navBar/icon_home_white.png');
			}
		}
	}
	.left_box {
	...
	.left_info {
		...
		.back {
			background-image: url('../../static/1navBar/icon_back_black.png');
		...
		.home {
			background-image: url('../../static/1navBar/icon_home_black.png');
			background-position: center center;
			background-repeat: no-repeat;
			background-size: auto 55%;
			width: $height;
