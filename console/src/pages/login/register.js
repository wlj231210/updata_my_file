...
export default class Register extends React.Component {
    ...
    getcode = async (e) => {
        ...
        if (mobile !== '' && pattern.test(mobile)) {
            let data = { mobile, ip }
            let res = await api.securitycode(data);
            if (res.code === 200) {
                    ...
                    <Row>
                        <Col xs={{ span: 20, offset: 1 }} lg={{ span: 5, offset: 2 }} style={{ margin: 'auto' }}>
                            ...
                            >
                                ...
                                >
                                    <Input placeholder="请输入邮箱" prefix={<MailOutlined style={{ color: 'rgba(0,0,0,.25)' }} />} />
                                </Form.Item>
                                ...
                                <Form.Item name="agreement" valuePropName="checked" className="mb-0 text-left">
                                    <Checkbox className="register-form-button" onChange={this.onChange}>
                                        我同意用户<Link to={`#`} >《注册协议》</Link>
                                    </Checkbox>
                                </Form.Item>
                                <Form.Item className="mb-0">
                                    {
                                        this.state.isagree ?
                                            ...
                                            <Button type="primary" disabled className="register-form-button">
                                                注册
                                          </Button>
                                    }
                                </Form.Item>
